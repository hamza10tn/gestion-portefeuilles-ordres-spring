...
public class LoggingAspect {
    @Pointcut("execution (* tn.esprit.examen.nomPrenomClasseExamen.services.IServices.addOrdreAndAffectToActionAndPortefeuille(..))")
...
/*
    ...
    public void logMethodExitReturn(JoinPoint joinPoint) {
        ...
        log.info("AfterReturning " + name + " L'ordre est en train d'etre traite ! ");
    }
/*
